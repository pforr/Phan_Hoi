...
/**
 * Provides the local service interface for TrangThaiGiaiTrinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tubq
 * @see TrangThaiGiaiTrinhLocalServiceUtil
...
public interface TrangThaiGiaiTrinhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TrangThaiGiaiTrinhLocalServiceUtil} to access the trang thai giai trinh local service. Add custom service methods to {@link vn.dtt.ns.yeucaugiaitrinh.dao.service.impl.TrangThaiGiaiTrinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
