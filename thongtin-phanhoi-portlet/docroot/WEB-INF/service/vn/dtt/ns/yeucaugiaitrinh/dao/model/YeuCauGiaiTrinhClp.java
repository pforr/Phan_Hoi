...
public class YeuCauGiaiTrinhClp extends BaseModelImpl<YeuCauGiaiTrinh>
	...
	public void setTrangThai(int trangThai) {
		...
		if (_yeuCauGiaiTrinhRemoteModel != null) {
			try {
				...
				method.invoke(_yeuCauGiaiTrinhRemoteModel, trangThai);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setDaChuyenSangMinhBach(int daChuyenSangMinhBach) {
		...
		if (_yeuCauGiaiTrinhRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setDaChuyenSangMinhBach",
						int.class);

				method.invoke(_yeuCauGiaiTrinhRemoteModel, daChuyenSangMinhBach);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	@Override
	public String getMaYeuCauGiaiTrinh() {
		return _maYeuCauGiaiTrinh;
	}

	@Override
	public void setMaYeuCauGiaiTrinh(String maYeuCauGiaiTrinh) {
		_maYeuCauGiaiTrinh = maYeuCauGiaiTrinh;

		if (_yeuCauGiaiTrinhRemoteModel != null) {
			try {
				Class<?> clazz = _yeuCauGiaiTrinhRemoteModel.getClass();

				Method method = clazz.getMethod("setMaYeuCauGiaiTrinh",
						String.class);

				method.invoke(_yeuCauGiaiTrinhRemoteModel, maYeuCauGiaiTrinh);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setDaChuyenSangMinhBach(getDaChuyenSangMinhBach());
		clone.setMaYeuCauGiaiTrinh(getMaYeuCauGiaiTrinh());
	...
	public String toString() {
		...
		sb.append(getMaYeuCauGiaiTrinh());
		sb.append("}");
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>maYeuCauGiaiTrinh</column-name><column-value><![CDATA[");
		sb.append(getMaYeuCauGiaiTrinh());
		sb.append("]]></column-value></column>");
	...
	private String _maYeuCauGiaiTrinh;
