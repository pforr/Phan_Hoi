...
public class TrangThaiGiaiTrinhModelImpl extends BaseModelImpl<TrangThaiGiaiTrinh>
	...
	public static final String TABLE_SQL_CREATE = "create table ws_trangthai_giaitrinh (id LONG not null primary key,yeucau_giaitrinh_id LONG,trangthai INTEGER,ghichu_nguoitao VARCHAR(75) null,userId LONG,ngaytao DATE null,ngaycapnhat DATE null,ghichu_nguoiduyet VARCHAR(75) null)";
	...
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.dtt.ns.yeucaugiaitrinh.dao.model.TrangThaiGiaiTrinh"),
			true);
	public static long YEUCAUGIAITRINHID_COLUMN_BITMASK = 1L;
	...
	public Object clone() {
		...
		trangThaiGiaiTrinhImpl.setNgayCapNhat(getNgayCapNhat());
	...
	public void resetOriginalValues() {
		TrangThaiGiaiTrinhModelImpl trangThaiGiaiTrinhModelImpl = this;

		trangThaiGiaiTrinhModelImpl._originalYeuCauGiaiTrinhId = trangThaiGiaiTrinhModelImpl._yeuCauGiaiTrinhId;

		trangThaiGiaiTrinhModelImpl._setOriginalYeuCauGiaiTrinhId = false;

		trangThaiGiaiTrinhModelImpl._columnBitmask = 0;
	}
	...
	public CacheModel<TrangThaiGiaiTrinh> toCacheModel() {
		...
		if (ngayCapNhat != null) {
			trangThaiGiaiTrinhCacheModel.ngayCapNhat = ngayCapNhat.getTime();
		}
		else {
			trangThaiGiaiTrinhCacheModel.ngayCapNhat = Long.MIN_VALUE;
		}
