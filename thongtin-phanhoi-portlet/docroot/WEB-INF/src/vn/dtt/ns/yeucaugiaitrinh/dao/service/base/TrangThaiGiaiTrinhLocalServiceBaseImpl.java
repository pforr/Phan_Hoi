...
import vn.dtt.ns.yeucaugiaitrinh.dao.service.TrangThaiGiaiTrinhLocalService;
...
/**
 * Provides the base implementation for the trang thai giai trinh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.ns.yeucaugiaitrinh.dao.service.impl.TrangThaiGiaiTrinhLocalServiceImpl}.
 * </p>
 *
 * @author tubq
 ...
 * @generated
 */
public abstract class TrangThaiGiaiTrinhLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrangThaiGiaiTrinhLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.ns.yeucaugiaitrinh.dao.service.TrangThaiGiaiTrinhLocalServiceUtil} to access the trang thai giai trinh local service.
	 */
	...
	@Override
	public TrangThaiGiaiTrinh addTrangThaiGiaiTrinh(
		TrangThaiGiaiTrinh trangThaiGiaiTrinh) throws SystemException {
		trangThaiGiaiTrinh.setNew(true);

		return trangThaiGiaiTrinhPersistence.update(trangThaiGiaiTrinh);
	}
	 ...
	 */
	@Override
	public TrangThaiGiaiTrinh createTrangThaiGiaiTrinh(long id) {
		return trangThaiGiaiTrinhPersistence.create(id);
	}
	...
	@Override
	public TrangThaiGiaiTrinh deleteTrangThaiGiaiTrinh(long id)
		throws PortalException, SystemException {
		return trangThaiGiaiTrinhPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TrangThaiGiaiTrinh deleteTrangThaiGiaiTrinh(
		TrangThaiGiaiTrinh trangThaiGiaiTrinh) throws SystemException {
		return trangThaiGiaiTrinhPersistence.remove(trangThaiGiaiTrinh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TrangThaiGiaiTrinh.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return trangThaiGiaiTrinhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trangThaiGiaiTrinhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TrangThaiGiaiTrinh fetchTrangThaiGiaiTrinh(long id)
		throws SystemException {
		return trangThaiGiaiTrinhPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TrangThaiGiaiTrinh getTrangThaiGiaiTrinh(long id)
		throws PortalException, SystemException {
		return trangThaiGiaiTrinhPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trangThaiGiaiTrinhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TrangThaiGiaiTrinh> getTrangThaiGiaiTrinhs(int start, int end)
		throws SystemException {
		return trangThaiGiaiTrinhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTrangThaiGiaiTrinhsCount() throws SystemException {
		return trangThaiGiaiTrinhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TrangThaiGiaiTrinh updateTrangThaiGiaiTrinh(
		TrangThaiGiaiTrinh trangThaiGiaiTrinh) throws SystemException {
		return trangThaiGiaiTrinhPersistence.update(trangThaiGiaiTrinh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.ns.yeucaugiaitrinh.dao.model.TrangThaiGiaiTrinh",
			trangThaiGiaiTrinhLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trangThaiGiaiTrinhPersistence.getDataSource();
	...
	private TrangThaiGiaiTrinhLocalServiceClpInvoker _clpInvoker = new TrangThaiGiaiTrinhLocalServiceClpInvoker();
}