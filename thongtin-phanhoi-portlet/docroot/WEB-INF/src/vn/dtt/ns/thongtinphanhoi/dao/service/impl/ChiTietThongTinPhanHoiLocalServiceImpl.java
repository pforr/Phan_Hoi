...
public class ChiTietThongTinPhanHoiLocalServiceImpl
	...
	public long countThongKePhanHoi(String maTinh, int month, int year) throws SystemException{	
		return chiTietThongTinPhanHoiFinder.countThongKePhanHoi(maTinh, month, year);
	}
	
	public List<TopicPhanHoi> searchThongKePhanHoi(String maTinh, int month, int year, int start, int end) throws SystemException{	
		return chiTietThongTinPhanHoiFinder.searchThongKePhanHoi(maTinh, month, year, start, end);
	}
	
	public long countThongKePhanHoiByTrangThai(int trangThai, String topicCode, String maTinh, Date fromDate, Date toDate) throws SystemException{	
		return chiTietThongTinPhanHoiFinder.countThongKePhanHoiByTrangThai(trangThai, topicCode, maTinh, fromDate, toDate);
	}
}