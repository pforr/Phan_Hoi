...
<liferay-portlet:renderURL varImpl="searchURL">
	<portlet:param name="mvcPath" value='<%= templatePath + "type_view/6.jsp" %>'/>
</liferay-portlet:renderURL>


<c:if test="<%= Validator.isNotNull(um) && um.getUserType() == 6 && UserNSPermission.contains(permissionChecker, scopeGroupId, ActionKeys.ADMIN_USER) %>">
	...
	<aui:form action="<%= searchURL %>" method="get" name="fm2">
		...
		<aui:fieldset>
			<liferay-ui:search-container delta="<%= 100 %>" emptyResultsMessage="no-result-were-found">
				...
				<liferay-ui:search-container-results results="<%= UserMappingBusiness.findUser(StringPool.BLANK, 6, maTinh, StringPool.BLANK, searchContainer.getStart(), searchContainer.getEnd()) %>"
									 total="<%= UserMappingBusiness.countUser(StringPool.BLANK, 6, maTinh, StringPool.BLANK) %>">
	...
	<aui:form action="<%= searchURL %>" method="get" name="fm2">
		...
		<aui:fieldset>
			<liferay-ui:search-container delta="<%= 100 %>" emptyResultsMessage="no-result-were-found">
				...
				<liferay-ui:search-container-results results="<%= UserMappingBusiness.findUser(StringPool.BLANK, 7, maTinh, StringPool.BLANK, searchContainer.getStart(), searchContainer.getEnd()) %>"
									 total="<%= UserMappingBusiness.countUser(StringPool.BLANK, 7, maTinh, StringPool.BLANK) %>">
	...
	<aui:form action="<%= searchURL %>" method="get" name="fm2">
		...
		<aui:fieldset>
			<liferay-ui:search-container delta="<%= 100 %>" emptyResultsMessage="no-result-were-found">
				...
				<liferay-ui:search-container-results results="<%= UserMappingBusiness.findUser(StringPool.BLANK, 8, maTinh, StringPool.BLANK, searchContainer.getStart(), searchContainer.getEnd()) %>"
									 total="<%= UserMappingBusiness.countUser(StringPool.BLANK, 8, maTinh, StringPool.BLANK) %>">
