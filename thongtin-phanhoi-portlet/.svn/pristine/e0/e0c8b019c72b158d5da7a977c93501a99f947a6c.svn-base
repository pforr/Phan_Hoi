...
import vn.dtt.ns.yeucaugiaitrinh.dao.service.YeuCauGiaiTrinhService;
...
/**
 * Provides the base implementation for the yeu cau giai trinh remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.ns.yeucaugiaitrinh.dao.service.impl.YeuCauGiaiTrinhServiceImpl}.
 * </p>
 *
 * @author tubq
 ...
 * @generated
 */
public abstract class YeuCauGiaiTrinhServiceBaseImpl extends BaseServiceImpl
	implements YeuCauGiaiTrinhService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.ns.yeucaugiaitrinh.dao.service.YeuCauGiaiTrinhServiceUtil} to access the yeu cau giai trinh remote service.
	 */
	...
	private YeuCauGiaiTrinhServiceClpInvoker _clpInvoker = new YeuCauGiaiTrinhServiceClpInvoker();
}