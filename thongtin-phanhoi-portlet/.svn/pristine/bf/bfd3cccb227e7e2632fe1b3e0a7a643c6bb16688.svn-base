...
public class TrangThaiThongKePhanHoiModelImpl extends BaseModelImpl<TrangThaiThongKePhanHoi>
	...
	public Object clone() {
		...
		trangThaiThongKePhanHoiImpl.setGroupId(getGroupId());
		trangThaiThongKePhanHoiImpl.setUserId(getUserId());
		trangThaiThongKePhanHoiImpl.setVersion(getVersion());
	...
	public CacheModel<TrangThaiThongKePhanHoi> toCacheModel() {
		...
		trangThaiThongKePhanHoiCacheModel.groupId = getGroupId();

		trangThaiThongKePhanHoiCacheModel.userId = getUserId();

		trangThaiThongKePhanHoiCacheModel.version = getVersion();

		String version = trangThaiThongKePhanHoiCacheModel.version;

		if ((version != null) && (version.length() == 0)) {
			trangThaiThongKePhanHoiCacheModel.version = null;
		}
