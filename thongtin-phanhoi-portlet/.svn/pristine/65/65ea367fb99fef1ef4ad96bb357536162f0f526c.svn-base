...
import vn.dtt.ns.thongtinphanhoi.dao.service.TopicPhanHoiService;
...
/**
 * Provides the base implementation for the topic phan hoi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.ns.thongtinphanhoi.dao.service.impl.TopicPhanHoiServiceImpl}.
 * </p>
 *
 * @author tubq
 ...
 * @generated
 */
public abstract class TopicPhanHoiServiceBaseImpl extends BaseServiceImpl
	implements TopicPhanHoiService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.ns.thongtinphanhoi.dao.service.TopicPhanHoiServiceUtil} to access the topic phan hoi remote service.
	 */
	...
	private TopicPhanHoiServiceClpInvoker _clpInvoker = new TopicPhanHoiServiceClpInvoker();
}