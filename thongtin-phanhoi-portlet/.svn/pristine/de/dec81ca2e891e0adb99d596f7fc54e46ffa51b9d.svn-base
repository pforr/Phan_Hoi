...
import vn.dtt.ns.thongtinphanhoi.dao.service.ChiTietThongTinPhanHoiService;
...
/**
 * Provides the base implementation for the chi tiet thong tin phan hoi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.ns.thongtinphanhoi.dao.service.impl.ChiTietThongTinPhanHoiServiceImpl}.
 * </p>
 *
 * @author tubq
 ...
 * @generated
 */
public abstract class ChiTietThongTinPhanHoiServiceBaseImpl
	extends BaseServiceImpl implements ChiTietThongTinPhanHoiService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.ns.thongtinphanhoi.dao.service.ChiTietThongTinPhanHoiServiceUtil} to access the chi tiet thong tin phan hoi remote service.
	 */
	...
	private ChiTietThongTinPhanHoiServiceClpInvoker _clpInvoker = new ChiTietThongTinPhanHoiServiceClpInvoker();
}