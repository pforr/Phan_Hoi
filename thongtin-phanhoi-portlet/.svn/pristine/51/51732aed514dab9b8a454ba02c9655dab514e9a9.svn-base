...
public class TopicPhanHoiModelImpl extends BaseModelImpl<TopicPhanHoi>
	...
	public static final String TABLE_SQL_CREATE = "create table thongtinphanhoi_TopicPhanHoi (code VARCHAR(75) not null primary key,matinh VARCHAR(75) null,mahuyen VARCHAR(75) null,maxa VARCHAR(75) null,name VARCHAR(75) null)";
	...
	public Object clone() {
		...
		topicPhanHoiImpl.setMaXa(getMaXa());
	...
	public CacheModel<TopicPhanHoi> toCacheModel() {
		...
		topicPhanHoiCacheModel.maXa = getMaXa();

		String maXa = topicPhanHoiCacheModel.maXa;

		if ((maXa != null) && (maXa.length() == 0)) {
			topicPhanHoiCacheModel.maXa = null;
		}
