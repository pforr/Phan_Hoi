...
import vn.dtt.ns.thongtinphanhoi.dao.service.TopicDetailsLocalService;
...
/**
 * Provides the base implementation for the topic details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.ns.thongtinphanhoi.dao.service.impl.TopicDetailsLocalServiceImpl}.
 * </p>
 *
 * @author tubq
 * @see vn.dtt.ns.thongtinphanhoi.dao.service.impl.TopicDetailsLocalServiceImpl
 * @see vn.dtt.ns.thongtinphanhoi.dao.service.TopicDetailsLocalServiceUtil
 * @generated
 */
public abstract class TopicDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TopicDetailsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.ns.thongtinphanhoi.dao.service.TopicDetailsLocalServiceUtil} to access the topic details local service.
	 */
	...
	@Override
	public TopicDetails addTopicDetails(TopicDetails topicDetails)
		throws SystemException {
		topicDetails.setNew(true);

		return topicDetailsPersistence.update(topicDetails);
	}
	 ...
	 */
	@Override
	public TopicDetails createTopicDetails(long id) {
		return topicDetailsPersistence.create(id);
	}
	...
	@Override
	public TopicDetails deleteTopicDetails(long id)
		throws PortalException, SystemException {
		return topicDetailsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TopicDetails deleteTopicDetails(TopicDetails topicDetails)
		throws SystemException {
		return topicDetailsPersistence.remove(topicDetails);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TopicDetails.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return topicDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return topicDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TopicDetails fetchTopicDetails(long id) throws SystemException {
		return topicDetailsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TopicDetails getTopicDetails(long id)
		throws PortalException, SystemException {
		return topicDetailsPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return topicDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TopicDetails> getTopicDetailses(int start, int end)
		throws SystemException {
		return topicDetailsPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTopicDetailsesCount() throws SystemException {
		return topicDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TopicDetails updateTopicDetails(TopicDetails topicDetails)
		throws SystemException {
		return topicDetailsPersistence.update(topicDetails);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.ns.thongtinphanhoi.dao.model.TopicDetails",
			topicDetailsLocalService);
	}
	...
	private TopicDetailsLocalServiceClpInvoker _clpInvoker = new TopicDetailsLocalServiceClpInvoker();
}